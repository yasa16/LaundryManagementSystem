...
<div class="container-fluid">
  <div class="row content">
	...
	<h3 style = "background-color:#94d1ff;">Update enquiry status </h3>

	<fieldset style = "background-color:#bffffe;"><br/><br/><br/>
	<form action = "updateEnq" method = "post" style = "padding-left:30px;">
		...
		Enquiry Status : <input type = "text" name = "status" value = "<%= status %>"><br/><br/>
