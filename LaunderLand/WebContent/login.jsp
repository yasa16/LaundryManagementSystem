...
<title>User Login | LaunderLand </title>
<meta charset="utf-8">
...
<div class="container-lg pt-5">
	...
	<div class = "form-group">
		<form action="log" method ="post">
			User Name <br> <input type = "text" class="form-control" name = "uid" required><br><br>
			Password <br> <input type= "password" class="form-control" name = "pwd" required><br>
			</div>
			
			<button type = "submit" name = "submit" value = "Login" class = "btn btn-outline-primary "><span class="spinner-grow spinner-grow-sm"></span>
			Login</button>
		</form>
</div>
<br>
