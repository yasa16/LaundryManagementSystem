...
<%
	...
	<h1 style="text-align: center;">Confirm Price Details</h1>
	<form action = "delete" method = "post">
			<div class="form-group mt-3">  
				Item Code : <br>
			    <input type ="text" class="form-control" name = "icode" value = "<%= Item_code %>" readonly>
			   
			   	Item Name : <br>
			    <input type ="text" class="form-control" name = "name" value = "<%= Item_name %>">
			    
			    Three Days : <br>
			    <input type ="text" class="form-control" name = "threedays" value = "<%= Three_days %>">
			    
			    Two Days : <br>
			    <input type ="text" class="form-control" name = "twodays" value = "<%= Two_days %>">
			    
			    One Day : <br>
			    <input type ="text" class="form-control" name = "oneday" value = "<%= Oneday %>">
			    
			    Express : <br>
			    <input type ="text" class="form-control" name = "express" value = "<%= Express %>"> 
			    
			    Urgent : <br>
			    <input type ="text" class="form-control" name = "urgent" value = "<%= Urgent %>"> 
				<br>
				<center>
				<input type="submit" class="btn btn-primary" value ="Confirm" width ="500px"></center><br>
			</div>
		</form>
