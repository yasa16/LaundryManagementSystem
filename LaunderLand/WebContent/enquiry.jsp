  ...
  <div class="row content">
			<div class="col-sm-2 sidenav hidden-xs">
				...
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="<%=request.getContextPath()%>/OurUsers">View
							Users</a></li>
					<li><a href="<%=request.getContextPath()%>/OurOrders">Order
							Management</a></li>
					<li><a href="<%=request.getContextPath()%>/OurPriceList">Manage
							Laundry Price</a></li>
      ...
      <%--View enquiry action form--%>
      
      <div style = "margin:50px;">
		<center>
		<h3 style = "background-color:#94d1ff;"> CUSTOMER ENQUIRIES </h3>
		<form action = "enquire" method = "post">
		<input type = "submit" value = "View Enquiry Details" name = "submit" style = "background-color:#94d1ff;"><br/>
		</form>
 		</center>
	</div>
