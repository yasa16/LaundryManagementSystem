...
<title>Success | Launder Land</title>
<meta charset="utf-8">
...
<div class= "container-fluid banner">
	<div class= "container-lg pt5">
		<br><br><br>
		<h1 style= "color:white">You have Successfully Placed the Order!</h1>
		<p style= "color:white">You can see your orders by clicking the below button</p>
		<form action= "listOrders" method= "post">
			<button type= "submit" name= "showOrders" class = "btn btn-outline-primary">Click me!</button>
		</form>
	</div>
</div>
