...
<title>Operation Success | Launder Land</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" type="text/css" href="Styles/successStyle.css">
...
<div class= "container-fluid banner">
	...
	<h1 style = "">You have successfully updated your details!</h1>
	<br>
	<br>
	<form action= "back" method= "post">
		<button type= "submit" name= "back" class= "btn btn-outline-primary"><span class="spinner-grow spinner-grow-sm"></span>Back to profile</button>
	</form>
	</div>
</div>
<br>
